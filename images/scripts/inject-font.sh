...
INJECTION='<link rel="preload" href="../static/lab/fonts/FiraCodeNerdFontMono-Regular.ttf" as="font" type="font/ttf" crossorigin>
<style>
@font-face {
  font-family: "FiraCode Nerd Font";
  src: url("../static/lab/fonts/FiraCodeNerdFontMono-Regular.ttf") format("truetype");
  font-weight: 400;
  font-display: block;
}
@font-face {
  font-family: "FiraCode Nerd Font";
  src: url("../static/lab/fonts/FiraCodeNerdFontMono-Bold.ttf") format("truetype");
  font-weight: 700;
  font-display: block;
}
</style>
...
# Insert before </head>
sed -i "s|</head>|${INJECTION}</head>|" "$INDEX_HTML"
echo "Font injection complete: $INDEX_HTML"
